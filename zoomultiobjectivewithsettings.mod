...
*/
    ...
    float weigths[1..2] = [1,1];
    float abstol[k in 1..2] = 0.0001;
    float reltol[k in 1..2] = 0.0001;
    int priorities[1..2] = [1,2];
    
    int times[1..2] = [5,10];
    float gaps[i in 1..2] = 0.0001;
...
//works but the following allows more settings
         
    minimize
      staticLexFull(kpis, weigths, priorities, abstol, reltol);
